...
CM_RRAM_API_WRITE_BYTE      = b'\x58'.decode('utf-8')
CM_RRAM_API_WRITE_BYTE_ITER = b'\x59'.decode('utf-8')
CM_RRAM_API_CONF_READ       = b'\x5A'.decode('utf-8')
CM_RRAM_API_READ_LANE       = b'\x5B'.decode('utf-8')
CM_RRAM_API_READ_BYTE       = b'\x5C'.decode('utf-8')
CM_RRAM_API_CONF_ADC        = b'\x5D'.decode('utf-8')
CM_RRAM_API_CONF_MAC        = b'\x5E'.decode('utf-8')
